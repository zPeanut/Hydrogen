...
public class EventWorldListener {
    ...
    public void onWorld(WorldEvent.Load e) {
        ...
        if (world != null && Hydrogen.getClient().firstStart) {
            ...
            Utils.sendChatMessage(EnumChatFormatting.GRAY + "To get started, press §f[" + Keyboard.getKeyName(Hydrogen.getClient().moduleManager.getModule(ClickGuiModule.class).getKeybind()) + "]§7 to open the ClickGUI!");

package tk.peanut.phosphor.scripting.runtime.minecraft.client;

import net.minecraft.client.Minecraft;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.entity.WrapperEntityPlayerSP;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.gui.WrapperFontRenderer;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.gui.WrapperGuiIngame;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.gui.WrapperGuiScreen;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.multiplayer.WrapperPlayerControllerMP;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.multiplayer.WrapperServerData;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.multiplayer.WrapperWorldClient;
import tk.peanut.phosphor.scripting.runtime.minecraft.client.network.WrapperNetHandlerPlayClient;
import tk.peanut.phosphor.scripting.runtime.minecraft.entity.WrapperEntity;
import tk.peanut.phosphor.scripting.runtime.minecraft.profiler.WrapperProfiler;
import tk.peanut.phosphor.scripting.runtime.minecraft.util.WrapperSession;
import tk.peanut.phosphor.scripting.runtime.minecraft.world.WrapperWorldSettings;

...
public class FontHelper {
    ...
    public static void loadFonts() {
        try {
            ...
            InputStream stream4 = FontHelper.class.getClass().getResourceAsStream("/assets/hydrogen/Comfortaa-Regular.ttf");
            Font font4 = Font.createFont(Font.TRUETYPE_FONT, stream4).deriveFont(36f);
            comfortaa_r = new H2FontRenderer(font4, true, 8);

            InputStream stream5 = FontHelper.class.getClass().getResourceAsStream("/assets/hydrogen/Comfortaa-Regular.ttf");
            ...
            InputStream stream = FontHelper.class.getClass().getResourceAsStream("/assets/hydrogen/SF-UI-Display-Light.ttf");
            Font font = Font.createFont(Font.TRUETYPE_FONT, stream).deriveFont(36f);
            sf_l = new H2FontRenderer(font, true, 8);

            InputStream stream33 = FontHelper.class.getClass().getResourceAsStream("/assets/hydrogen/SF-UI-Display-Light.ttf");

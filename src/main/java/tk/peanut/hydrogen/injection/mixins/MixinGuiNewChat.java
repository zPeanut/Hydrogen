...
import tk.peanut.hydrogen.module.modules.render.NoChatRect;
    ...
    public void drawChat(int updateCounter) {
        if (Minecraft.getMinecraft().gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN) {
            ...
            if (k > 0) {
                    ...
                    if (chatline != null) {
                        ...
                        if (j1 < 200 || flag) {
                            ...
                            if (l1 > 3) {
                                ...
                                if(!Hydrogen.getClient().moduleManager.getModule(NoChatRect.class).isEnabled()) {
                ...
                if (flag) {
                    i1 = Minecraft.getMinecraft().fontRendererObj.FONT_HEIGHT;
